...
/// This function will request [1 mode](`crate::global_api::modes::Response`) from the [GlobalAPI](https://kztimerglobal.com/swagger/index.html?urls.primaryName=V2) and return it.
